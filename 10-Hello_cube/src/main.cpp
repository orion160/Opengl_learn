...
int main(int argc, char** argv)
{
	...
	Shader shader("C:/dev/c++/Opengl_learn/10-Hello_cube/resources/shaders/vertex/vertex_texture.shader", "C:/dev/c++/Opengl_learn/10-Hello_cube/resources/shaders/fragment/fragment_texture.shader");
	...
	unsigned char* data = stbi_load("C:/dev/c++/Opengl_learn/10-Hello_cube/resources/images/container.jpg", &width, &height, &nrChannels, 0);
	if (data)
	{
	...
	data = stbi_load("C:/dev/c++/Opengl_learn/10-Hello_cube/resources/images/awesomeface.png", &width, &height, &nrChannels, 0);
	if (data)
	{
