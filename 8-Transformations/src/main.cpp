...
int main(int argc, char** argv)
{
	...
	Shader shader("C:/dev/c++/Opengl_learn/8-Transformations/resources/shaders/vertex/vertex_texture.shader", "C:/dev/c++/Opengl_learn/8-Transformations/resources/shaders/fragment/fragment_texture.shader");
	...
	data = stbi_load("C:/dev/c++/Opengl_learn/8-Transformations/resources/images/awesomeface.png", &width, &height, &nrChannels, 0);
	if (data)
	{
